        ...
        <article className="min-h-screen py-24 px-6 max-w-4xl mx-auto animate-in fade-in duration-700">
            ...
            <div className="prose prose-neutral prose-lg text-primary max-w-none space-y-12 font-light">
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        What is happening in 2025–2026 is different in kind. We are moving from assistive AI that helps humans read faster, to <strong>agentic AI that conducts research autonomously</strong> — formulating hypotheses, designing experiments, executing code, reading full-text papers through tools, and writing manuscripts. The loop is starting to close.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base marker:text-secondary">
                        ...
                        <li><strong>Sakana AI</strong>'s <em>AI Scientist v2</em> became, in 2025, the first system to produce a fully AI-generated paper accepted through a peer-reviewed workshop. The work has since been consolidated in <em>Nature</em> (March 2026).</li>
                        <li><strong>Argonne, Oak Ridge, and Lawrence Berkeley National Laboratories</strong> now operate autonomous, AI-driven materials laboratories.</li>
                    </ul>
                    <p>
                        None of this is finished work. These agents still hallucinate citations, miss methodological subtleties, and produce incremental ideas at least as often as novel ones. But machine learning follows a consistent pattern: once a capability starts to work — even poorly — scale and better base models tend to push it past human performance faster than most people expect.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        The risks are real — AI slop, reproducibility crises, misuse. But the counterfactual is not a pristine slow science; it is the current system, which already produces an overwhelming and partly unreliable literature. Agents that <strong>verify, cross-check, and stress-test other agents' output</strong> will matter as much as agents that generate.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base marker:text-secondary">
                        <li>Sakana AI. <em>The AI Scientist-v2: Workshop-Level Automated Scientific Discovery via Agentic Tree Search</em>. arXiv:2504.08066 (2025).</li>
                        <li>Sakana AI. <em>The AI Scientist: Towards Fully Automated AI Research</em>. Published in <em>Nature</em> (March 2026).</li>
